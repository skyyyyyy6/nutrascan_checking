...
CORS(app, origins=["https://b646-103-19-109-57.ngrok-free.app", "http://localhost:5000"])
...
def capture_endpoint():
    ...
    try:
        ...
        logging.info(f"Food prediction took {time.time() - start_prediction_time} seconds")
    except Exception as e:
    ...
    return jsonify({
        ...
        "nutrition_info": [
            ...
            for key, value in result.get("nutrition_info", {}).items()
        ]
    })
